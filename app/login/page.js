                ...
                <div className="w-full max-w-md bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-green-200 p-6 sm:p-8">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handleSubmit(Submit)}>
                        ...
                        <div>
                            ...
                            />
                            {errors.username && (
                                <p className="text-red-500 w-full text-center text-sm mt-1">{errors.username.message}</p>
                            )}
                        </div>
                        ...
                        <p onClick={() => router.push("/reset-password")} className="text-green-600 text-sm text-center cursor-pointer hover:underline">
                            Forgot Password?
                        </p>
